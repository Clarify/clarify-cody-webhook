 ...
 *
 * See lib/test/mocks.js for sample insight results JSON.
 */

var Controller = function(request, app) {

    this.logger = request.server;
...
Controller.prototype.getInsightsForConversation = function(conversation, insights, callback) {
    ...
    this.app.codyClient.getLink(conversation, 'self', qs, function (err, conversationWithEmbeds) {
        if (err) {
            ...
            callback(Boom.serverUnavailable('Error getting conversation with insights'));
        } else {
...
Controller.prototype.processConversation = function(conversation, callback) {
    ...
    self.getInsightsForConversation(conversation, undefined, function (err, insights) {
        ...
        self.processMediaInsight(conversation, insights['insight:media'], function(err) {
            ...
            // See lib/test/mocks.js for samples
            /////////////////////////////////////////////////////////////////////
            /*
